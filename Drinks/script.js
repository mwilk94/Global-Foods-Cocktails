...
//displays results of cuisine search in cards
     ...
     <div class="card">
       <div class="card-image">
        ...
        <div class="card-content">
          ...
          <p class="car*d-text">Cuisine: ${results.recipe.cuisineType}
          </p>
...
//displays results of drink search in cards
     ...
     <div class="card">
       <div class="card-image">
        ...
        <div class="card-content">
          ...
          <p class="car*d-text">Source: ${results.sourceName}
          </p>
